...
// jumlah user
$jumlahUser = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_user WHERE id_user"));
// jumlah TASK	
...
<head>
	...
	<title>CEO |Aplikasi Laporan Manajemen </title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" href="../assets/img/ide_kite_logo_black-removebg-preview" type="image/x-icon" />
...
<body>
	<div class="wrapper">
		...
		<div class="sidebar sidebar-style-2">
			<div class="sidebar-wrapper " style="background-color: #e96020;">
				...
				<ul class="nav text-white">
					...
					<li class="nav-item <?php echo (isset($_GET['page']) && $_GET['page'] == 'user') ? 'active' : ''; ?>">
						<a href="?page=user" class="nav-link">
							<div class="d-flex align-items-center">
								<img src="../assets/img/ICON/ikon_data_user-removebg-preview.png" alt="User Icon" width="24" height="24" class="me-2">
		...
		<style>
			.nav-item img {
				margin-right: 8px;
				/* Sesuaikan margin kanan sesuai keinginan Anda */
			}
			...
			<div class="content">
				...
				if ($page == 'user') {
					if ($act == '') {
						...
						include 'modul/user/del.php';
					} elseif ($act == 'proses') {
						include 'modul/user/proses.php';
					}
				} elseif ($page == 'task') {
					if ($act == '') {
