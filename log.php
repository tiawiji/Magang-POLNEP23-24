...
<body>
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="background-color: #e96020;">
            <!-- Logo Header -->
            <div class="container">
                <div class="logo-header" data-background-color="blue2">

                    <a href="index.php">
                        <img src="assets/img/ide_kite_logo_black-removebg-preview.png" alt="navbar brand" class="navbar-brand" width="40">
                        <b class="text-white"></b>
                    </a>IDE KITE INDONESIA
                </div>
            </div>
            <!-- End Logo Header -->
        </div>
        ...
        <div class="main-panel">
            <div class="content">
                <div class="panel-header " style="background-color: #ffff;">
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">IDE KITE INDONESIA</h2>
                                    <!-- <h5 class="text-white op-7 mb-2"> </h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">jl. jend.Ahmad Yani
                                        -Pontianak Kalimantan Barat,Kanada</a>
                                    <!-- <a href="view/mhs.php" class="btn btn-secondary btn-round"> </a> -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y'); ?> Berita Acara Perkuliahan.<a href="index.php">Kangguru </a> | 00001
                    </div>
                </div>
            </footer>
