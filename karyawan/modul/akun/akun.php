	...
	<div class="card">
		...
		<div class="card-body">
			<ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
				<li class="nav-item">
					<a class="nav-link" id="pills-home-tab-nobd" style="background-color: #e96020;" data-toggle="pill" href="#pills-home-nobd" role="tab" aria-controls="pills-home-nobd" aria-selected="true">Ganti Password</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="pills-profile-tab-nobd" style="background-color: #e96020;" data-toggle="pill" href="#pills-profile-nobd" role="tab" aria-controls="pills-profile-nobd" aria-selected="false">Ganti Foto</a>
				</li>
			</ul>
			<div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
				<div class="tab-pane fade show" id="pills-home-nobd" role="tabpanel" aria-labelledby="pills-home-tab-nobd">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							<button name="changePassword" style="background-color: #e96020;" type="submit" class="btn text-white">Save</button>
						</div>
				...
				<div class="tab-pane fade" id="pills-profile-nobd" role="tabpanel" aria-labelledby="pills-profile-tab-nobd">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<button name="updateProfile" style="background-color: #e96020;" type="submit" class="btn text-white">Save</button>
						</div>
...
<a href="javascript:history.back()" class="btn btn-default btn-block mb-1"><i class="fas fa-arrow-circle-left"></i> Back</a>